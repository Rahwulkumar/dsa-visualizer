...
const ArrayOperations = ({
  ...
  isAnimating // Ensure isAnimating is destructured
}) => {
  ...
  const sleep = useCallback(
    (multiplier = 1) => new Promise((resolve) => {
...
ArrayOperations.propTypes = {
  operation: PropTypes.string.isRequired,
  isPlaying: PropTypes.bool.isRequired,
  speed: PropTypes.number.isRequired,
  searchValue: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  accessIndex: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  insertValue: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  insertIndex: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  deleteIndex: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  displayArray: PropTypes.arrayOf(PropTypes.number).isRequired,
  memoryArray: PropTypes.arrayOf(PropTypes.number).isRequired,
