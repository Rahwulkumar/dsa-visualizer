...
const SortingControls = ({
  ...
  const operations = [
    { id: 'bubbleSort', label: 'Bubble Sort', icon: ArrowUpDown, color: 'from-blue-500 to-blue-600' },
    { id: 'quickSort', label: 'Quick Sort', icon: Zap, color: 'from-yellow-500 to-yellow-600' },
    { id: 'mergeSort', label: 'Merge Sort', icon: BarChart3, color: 'from-green-500 to-green-600' },
    { id: 'heapSort', label: 'Heap Sort', icon: TrendingUp, color: 'from-purple-500 to-purple-600' },
    { id: 'insertionSort', label: 'Insertion Sort', icon: ArrowUpDown, color: 'from-cyan-500 to-cyan-600' },
    { id: 'selectionSort', label: 'Selection Sort', icon: Activity, color: 'from-red-500 to-red-600' }
  ];
  ...
  const getPreviewElementStyle = (index) => {
    ...
    switch (state) {
      ...
      case 'pivot':
        ...
        break;
      case 'partitioning':
        className = 'bg-orange-600/90 border-orange-400 text-white shadow-lg shadow-orange-500/30';
        break;
      case 'merging':
  ...
  const handlePause = () => { // eslint-disable-line no-unused-vars
    if (onPause) {
      onPause();
    }
  };
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-gradient-to-r from-green-500/10 to-green-500/5 backdrop-blur-xl p-3 rounded-xl border border-green-500/20">
                      <div className="text-xs text-green-300 mb-1">Swaps</div>
                      <div className="text-lg font-bold text-green-200">{swaps}</div>
                    </div>
                  </div>
